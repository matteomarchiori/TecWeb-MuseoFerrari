...
switch ($uri_parts[0]){
    ...
    case "/mostre/mostra-corrente": // TABINDEX ACCESSKEY OK
        ...
        echo $header;
        require_once '../pages/mostra-corrente.php';
        break;
    case "/mostre/mostre-in-programma": // TABINDEX ACCESSKEY OK
        ...
        echo $header;
        require_once '../pages/mostre-in-programma.php';
        break;
    case "/modelli-esposti": // TABINDEX ACCESSKEY OK
        ...
        echo $header;
        require_once '../pages/modelli-esposti.php';
        break;
    case "/biglietti": // TABINDEX ACCESSKEY OK
        ...
        echo $header;
        require_once '../../html/pages/biglietti.html';
        break;
    case "/info-e-contatti": // TABINDEX ACCESSKEY OK
        ...
        echo $header;
        require_once '../pages/info-e-contatti.php';
        break;
    default:
        break;
}
