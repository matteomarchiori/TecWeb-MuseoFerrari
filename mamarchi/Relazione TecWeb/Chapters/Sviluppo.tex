...
In seguito l'idea è stata abbandonata a causa della necessità di porre degli url relativi per le risorse, poiché in tal caso l'url viene interpretato come path.
