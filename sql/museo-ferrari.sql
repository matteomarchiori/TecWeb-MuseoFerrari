...
(2, 'Ferrari Monza SP', 'A partire da Gennaio 2019 potrete ammirare le nuove icone Ferrari SP1 e SP2.Le Ferrari Monza SP1 e SP2 fanno parte della nuova gamma Icona. Questa sarà composta da modelli realizzati in numero ridotto ispirati a grandi Rosse del passato. Le prime supercar di queste nuova gamma (chiamata Icona) si rifanno alle Monza 750 e 860 di metà Anni 50, auto da corsa senza il tetto e il parabrezza. Le SP1 e SP2 hanno di conseguenza un aspetto evocativo, grazie alle forme essenziali della carrozzeria e ad una serie di particolari ispirati ai modelli originali, come ad esempio le piccole portiere laterali o la “bolla” con funzione aerodinamica dietro il sedile, che come suggerisce il nome è singolo sulla Ferrari Monza SP1 ma doppio sulla Monza SP2.', 'A partire da Gennaio 2019 potrete ammirare le nuove icone Ferrari SP1 e SP2. Le Ferrari Monza SP1 e SP2 fanno parte della nuova gamma Icona, composta da modelli ispirati a grandi Rosse del passato. Le prime supercar di queste nuova gamma si rifanno alle Monza 750 e 860 di metà Anni 50, auto da corsa senza il tetto e il parabrezza. Le SP1 e SP2 hanno di conseguenza un aspetto evocativo, grazie alle forme essenziali della carrozzeria e ad una serie di particolari ispirati ai modelli originali, come ad esempio le piccole portiere laterali o la “bolla” con funzione aerodinamica dietro il sedile.', './img/eventi/monza_sp1.jpg', 'corrente', '2019-01-01', '2019-06-30', 'Ferrari Monza SP1'),
